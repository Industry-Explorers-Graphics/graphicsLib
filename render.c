...
/* Triangulate a polygon and fill */
int pointInPolygon( int polyCorners, int polyX[], int polyY[], int x, int y )
{
...
float triangleArea( point *contour )
{
	int n = contour.size( );
...
bool triangulateSnip( point *contour, int u, int v, int w, int n, int *V )
{
	int p;
...
bool triangulate_process( point *contour )
{
